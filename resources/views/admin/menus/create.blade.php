                ...
                <form method="POST" action="{{ route('admin.menus.store') }}" enctype="multipart/form-data" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <input type="text" name="menu_code" value="{{ old('menu_code') }}"
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="number" name="preparation_time" value="{{ old('preparation_time', 10) }}" min="1"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <select name="stock_status" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                                <option value="available" @selected(old('stock_status') === 'available')>Available</option>
                                <option value="sold_out" @selected(old('stock_status') === 'sold_out')>Sold Out</option>
                            </select>
                            @error('stock_status')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
